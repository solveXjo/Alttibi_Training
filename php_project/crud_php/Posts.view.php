            ...
            <?php foreach ($posts as $post) : ?>
                <div class="post-card">
                    ...
                    <div class="post-header">
                        <img src="assets/default-avatar.jpg" alt="Profile" class="post-avatar">
                        <div>
                    ...
                    <div class="comments-section">
                        <?php if (!empty($post['comments'])) : ?>
                            <?php foreach ($post['comments'] as $comment) : ?>
                                <div class="comment">
                                    <img src="assets/default-avatar.jpg" alt="Profile" class="comment-avatar">
                        ...
                        <form method="post" action="../../comment.php" class="comment-form">
                            <input type="hidden" name="post_id" value="<?= $post['id'] ?>">
                            <img src="assets/default-avatar.jpg" alt="Profile" class="post-avatar" style="width: 32px; height: 32px;">
